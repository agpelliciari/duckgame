...
TextureContainer::TextureContainer(SDL2pp::Renderer& renderer):
        noTexture(SDL2pp::Texture(renderer, std::string(DATA_PATH) + NO_TEXTURE)) {
...
void TextureContainer::recursiveLoadTextures(SDL2pp::Renderer& renderer, const std::string& root,
