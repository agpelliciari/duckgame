...
SetHostnamePortWidget::SetHostnamePortWidget(const SetHostnamePortHandler& handler,
                                             QWidget* parent):
        QWidget(parent), ui(new Ui::SetHostnamePortWidget), handler(handler) {
    ui->setupUi(this);

    connect(ui->continueButton, &QPushButton::clicked, this,
            &SetHostnamePortWidget::onClickContinue);
    connect(ui->quitButton, &QPushButton::clicked, this, &SetHostnamePortWidget::onClickQuit);
}

SetHostnamePortWidget::~SetHostnamePortWidget() { delete ui; }
